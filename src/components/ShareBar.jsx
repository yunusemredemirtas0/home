...
import { FiLinkedin, FiTwitter, FiShare2, FiLink, FiCheck } from 'react-icons/fi';
...
export default function ShareBar({ title, url }) {
  ...
  return (
    <>
      ...
      <div className={`share-bar-desktop ${isVisible ? 'visible' : ''}`}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
          <div style={{ fontSize: '0.7rem', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '2px', opacity: 0.4, writingMode: 'vertical-lr', marginBottom: '1rem' }}>
            SHARE
          </div>
          {platforms.map((p) => (
