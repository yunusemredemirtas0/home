export const translations = {
  tr: {
    nav: { home: 'Ana Sayfa', about: 'Hakkımda', services: 'Hizmetler', projects: 'Projeler', contact: 'İletişim', login: 'Giriş Yap', dashboard: 'Panel' },
  ...
  en: {
    nav: { home: 'Home', about: 'About', services: 'Services', projects: 'Projects', contact: 'Contact', login: 'Login', dashboard: 'Dashboard' },
